...
따라서 4를 return 합니다.
*/
//실행 시간 3000~4000ms 나오는 거 보니 똥망. ㅋㅋ
function solution(n, m, section) {
  let answer = 0
  let wall = Array.from({length: n},(_,i)=>1).map((_,i)=>section.indexOf(i+1)>-1?0:1)
  
  while(wall.indexOf(0)>-1) {
      wall.splice(wall.indexOf(0),m,1)
      answer++
  }
