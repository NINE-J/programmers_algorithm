...
*/
//가장 양이 많은 테스트에 대한 실행 시간 0.24ms
function solution(wallpaper) {
  let l=wallpaper[0].length,u=wallpaper.length,r=0,d=0

  for(let i = 0; i < wallpaper.length; i++) {
      let fs = wallpaper[i].indexOf('#')
      let fe = wallpaper[i].lastIndexOf('#')
...
//정답 후 다른 사람의 풀이
//가장 양이 많은 테스트에 대한 실행 시간 0.44ms
//wallpaper의 양은 50*50까지 한정인 점
function solution(wallpaper) {
  let left = [];
  let top = [];
  let right = []
